...
The returned signals are shifted by a time difference $\tau$. 
...
t is known (like, the 5th second in a cycle that repeats every 10s), w is known, and voltage can be measured. So you can solve for $\tau$. But there is a problem, because this equation actually yields two results for $\tau$. 
